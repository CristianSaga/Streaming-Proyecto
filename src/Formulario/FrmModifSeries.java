...
public class FrmModifSeries extends javax.swing.JInternalFrame {
ConsultasGrales Cg = new ConsultasGrales();
Series sr = new Series () ;
Socios sc = new Socios ();

    public FrmModifSeries() {
        initComponents();
        this.LblTitulo.setText("Modificaciones y bajas de series");
        this.PanelBotones.setVisible(false);
        this.PanelDatos.setVisible(false);
        this.CmbSeries.setModel(Cg.MostrarCombos(2));
    ...
    private void initComponents() {
        ...
        jLabel1.setText("BUSCAR POR SERIE");

        CmbSeries.setFont(new java.awt.Font("Times New Roman", 1, 12)); // NOI18N
        CmbSeries.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 550, 170));
        ...
        TxtTituloSerie.setFont(new java.awt.Font("Times New Roman", 1, 12)); // NOI18N
            ...
            .addGroup(PanelDatosLayout.createSequentialGroup()
                ...
                .addGroup(PanelDatosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(PanelDatosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                        ...
                        .addComponent(TxtTituloSerie, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 197, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addComponent(TxtDuracion, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 108, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        PanelBotonesLayout.setHorizontalGroup(
            ...
            .addGroup(PanelBotonesLayout.createSequentialGroup()
                ...
                .addGroup(PanelBotonesLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(BtnConfirmar, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 144, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(BtnSalir, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 144, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(29, 29, 29))
        );
    ...
    private void BtnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnBuscarActionPerformed
        ...
        String serie = this.CmbSeries.getSelectedItem().toString();
        sr.BuscarSerie(serie);
        this.TxtTituloSerie.setText(sr.getTitSerie());
        this.TxtAño.setText(sr.getAño());
        this.TxtDuracion.setText(sr.getDuracion());
        this.TxtDirector.setText(sr.getDirector());
        this.TxtResumen.setText(sr.getResumen());
        this.CmbGen.setSelectedItem(sr.getTipogen());
        
        this.TxtTituloSerie.setEditable(false);
    ...
    private void BtnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnModificarActionPerformed
        this.TxtTituloSerie.setEditable(true);
    ...
    private void BtnConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnConfirmarActionPerformed
        sr.setTitSerie(this.TxtTituloSerie.getText().toUpperCase());
        sr.setAño(this.TxtAño.getText().toUpperCase());
        sr.setDuracion(this.TxtDuracion.getText().toUpperCase());
        sr.setDirector(this.TxtDirector.getText().toUpperCase());
        sr.setResumen(this.TxtResumen.getText());
        
        String nomgen = (this.CmbGen.getSelectedItem().toString());
        sc.BuscarCodGenporTipo(nomgen);
        int codplan = sc.getCodGen();
        sr.setCodGen(codplan);
        
          try {
            int valor = JOptionPane.showConfirmDialog(this, "Esta Seguro? ");
            if (valor == 0) {
                sr.Modif(this.CmbSeries.getSelectedItem().toString());  
            }
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, "NO QUIERE MODIFICAR ");
        }
        
        this.CmbSeries.removeAllItems();
        this.CmbSeries.setModel(Cg.MostrarCombos(2));
        this.PanelDatos.setVisible(false);
        this.PanelBotones.setVisible(false);   
    ...
    private void BtnBajasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnBajasActionPerformed
        try {
            ...
            if (valor == 0) {
                sr.Bajas(this.CmbSeries.getSelectedItem().toString());
            }
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, "NO QUIERE MODIFICAR ");
        }
    ...
    private javax.swing.JComboBox<String> CmbSeries;
